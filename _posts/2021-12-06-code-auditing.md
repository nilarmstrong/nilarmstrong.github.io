...
- #### [Function] luaC_newobj
  ...
  - **working process**
    ...
    - get new object by luaM_newobject and type cast into GCObject * 
    - as object is new it is set as white color
...
- #### [Function] propagatemark (lgc.c)
  ...
  - **working process**
    ...
    propagatemark works until it founds all objects for two cases above
    change gray object into black
