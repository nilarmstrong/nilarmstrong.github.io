...
![image-center]({{ '/images/fuzzing-lua-interpreter/code_ex.png' | absolute_url }}){: .align-center width="50%" height="30%"}
###### _Figure. 4_

##### 1. Rewrite
    
Change the name of all variables. (var1, var2... / The same goes for numbers)
![image-center]({{ '/images/fuzzing-lua-interpreter/code_ex_2.png' | absolute_url }}){: .align-center width="50%" height="30%"}
