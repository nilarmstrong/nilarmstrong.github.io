...
![image-center]({{ '/images/fuzzing-lua-interpreter/bytecode_ex.png' | absolute_url }}){: .align-center width="70%" height="50%"}
###### _Figure. 1_
...
![image-center]({{ '/images/fuzzing-lua-interpreter/js_ex.png' | absolute_url }}){: .align-center width="70%" height="50%"}
###### _Figure. 2_
...
![image-center]({{ '/images/fuzzing-lua-interpreter/code_ex.png' | absolute_url }}){: .align-center width="40%" height="25%"}
###### _Figure. 4_
...
![image-center]({{ '/images/fuzzing-lua-interpreter/code_ex_2.png' | absolute_url }}){: .align-center width="40%" height="25%"}
